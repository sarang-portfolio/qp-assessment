...
exports.orderItemsModel = utility_1.sequelize.define(
  database_constants_1.DATABASE_TABLES.ORDER_ITEM,
  {
    id: {
...
order_schema_1.orderModel.hasMany(exports.orderItemsModel, {
  foreignKey: 'orderId',
});
exports.orderItemsModel.belongsTo(order_schema_1.orderModel, {
  foreignKey: 'orderId',
});
exports.orderItemsModel.belongsTo(grocery_schema_1.groceryModel, {
  foreignKey: 'groceryId',
});
grocery_schema_1.groceryModel.hasMany(exports.orderItemsModel, {
  foreignKey: 'groceryId',
});
