...
exports.validateUpdateInventoryBody = exports.validateUpdateInventoryParams =
  void 0;
...
const createInventoryBodySchema = joi_1.default.object({
  ...
  action: joi_1.default
    .string()
    .valid(
      inventory_types_1.Action.increment,
      inventory_types_1.Action.decrement,
      inventory_types_1.Action.set,
    )
    .required()
    .messages({
