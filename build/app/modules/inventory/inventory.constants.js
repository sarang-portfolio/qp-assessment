...
exports.INVENTORY_CONSTANTS = {
    ...
    QUANTITY_TOO_LOW: new utility_1.MessageHandler(409, "QUANTITY CANNOT BE LESS THAN 0"),
    QUANTITY_TOO_HIGH: new utility_1.MessageHandler(409, `QUANTITY CANNOT EXCEED ${exports.QUANTITY_LIMIT.UPPER_LIMIT}`),
    ...
    INSUFFICIENT_INVENTORY: new utility_1.MessageHandler(409, "INSUFFICIENT INVENTORY"),
};
