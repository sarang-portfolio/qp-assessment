...
const grocery_service_1 = __importDefault(require("../grocery/grocery.service"));
...
const getOneinventory = (inventoryDto) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updateOneinventory = (groceryId, inventoryDto) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const groceryItem = yield grocery_service_1.default.getOneGrocery({ id: groceryId });
        if (!groceryItem)
            throw grocery_constants_1.GROCERY_CONSTANTS.NOT_FOUND;
        const inventory = yield getOneinventory({ id: groceryItem.id });
        if (!inventory)
            throw inventory_constants_1.INVENTORY_CONSTANTS.NOT_FOUND;
...
const checkInventory = (items) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let details = [];
        let success = true;
        for (const item of items) {
            ...
            if (!inventory || inventory.quantity < item.quantity) {
                ...
                details.push({
                    ...
                    available: (inventory === null || inventory === void 0 ? void 0 : inventory.quantity) || 0,
                });
            }
        }
