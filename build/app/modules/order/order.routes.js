...
exports.OrderRouter.post(
  common_1.ORDER_ROUTES.PRIVATE_CREATE_ORDER,
  (0, common_1.permit)([common_1.Roles.User]),
  order_validations_1.validateOrder,
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        const userId = res.locals.user.userId;
        const items = req.body.items;
        const response = yield order_service_1.default.createOrder(
          userId,
          items,
        );
        res
