...
const createOrder = (userId, items) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const totalAmount = yield grocery_service_1.default.calculateTotalAmount(items);
        const inventoryChecks = yield inventory_service_1.default.checkInventory(items);
