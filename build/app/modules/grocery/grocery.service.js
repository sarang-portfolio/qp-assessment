...
const createGrocery = (groceryDto) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getOneGrocery = (groceryDto) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updateOneGrocery = (id, groceryDto) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const deleteOneGrocery = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const isDeleted = yield grocery_repo_1.default.deleteOne(id);
        if (!isDeleted)
            throw grocery_constants_1.GROCERY_CONSTANTS.NOT_DELETED;
...
const calculateTotalAmount = (items) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        for (const item of items) {
            ...
            if (!grocery)
                throw `Grocery item with id ${item.groceryId} not found`;
