...
const create = (grocery) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const transaction = yield utility_1.sequelize.transaction();
    try {
      const newGrocery = yield grocery_schema_1.groceryModel.create(
...
const getAll = () =>
  grocery_schema_1.groceryModel.findAll({
...
const getOne = (grocery) =>
  grocery_schema_1.groceryModel.findOne({
    where: Object.assign(Object.assign({}, grocery), { deletedAt: null }),
  });
const updateOne = (id, grocery) =>
  grocery_schema_1.groceryModel.update(grocery, { where: { id } });
const deleteOne = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const transaction = yield utility_1.sequelize.transaction();
    try {
