...
exports.validateDeleteGrocery = exports.validateUpdateGroceryBody = exports.validateUpdateGroceryParams = exports.validateGrocery = exports.createGrocerySchema = void 0;
...
exports.createGrocerySchema = joi_1.default.object({
    ...
    price: joi_1.default.number().positive().precision(2).greater(0).required().messages({
...
const updateGroceryBodySchema = joi_1.default.object({
