 ...
 *                       example: FORBIDDEN
 */
exports.GroceryRouter.post(
  PRIVATE_CREATE_GROCERY,
  grocery_validations_1.validateGrocery,
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        ...
        const response =
          yield grocery_service_1.default.createGrocery(groceryDto);
 ...
 *                   example: null
 */
exports.GroceryRouter.get(
  PRIVATE_GET_ALL_GROCERY,
  (0, common_1.permit)([common_1.Roles.Admin, common_1.Roles.User]),
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
 ...
 */
exports.GroceryRouter.put(
  PRIVATE_UPDATE_GROCERY,
  grocery_validations_1.validateUpdateGroceryParams,
  grocery_validations_1.validateUpdateGroceryBody,
  (0, common_1.permit)([common_1.Roles.Admin]),
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        ...
        const groceryDto = req.body;
        const response = yield grocery_service_1.default.updateOneGrocery(
          groceryId,
          groceryDto,
        );
        res.send(new utility_1.ResponseHandler(response));
 ...
 */
exports.GroceryRouter.delete(
  PRIVATE_DELETE_GROCERY,
  grocery_validations_1.validateDeleteGrocery,
  (0, common_1.permit)([common_1.Roles.Admin]),
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        const groceryId = Number(req.params.id);
        const response =
          yield grocery_service_1.default.deleteOneGrocery(groceryId);
        res.send(new utility_1.ResponseHandler(response));
      } catch (error) {
        next(error);
      }
